...
func (mr *MockURLStorageMockRecorder) ShortenedLinkBatchCreate(ctx, urls interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockURLStorageMockRecorder) ShortenedLinkBatchExists(ctx, originalURLs interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockURLStorageMockRecorder) ShortenedLinkCreate(ctx, url interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockURLStorageMockRecorder) ShortenedLinkGetBatchByUser(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockURLStorageMockRecorder) ShortenedLinkGetByOriginalURL(ctx, originalURL interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockURLStorageMockRecorder) ShortenedLinkGetByShortKey(ctx, shortKey interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
