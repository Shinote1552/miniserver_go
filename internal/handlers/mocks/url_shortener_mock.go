...
// Source: urlshortener/internal/handlers (interfaces: URLshortener)
//
// Generated by this command:
//
//	mockgen -destination=mocks/url_shortener_mock.go -package=mocks urlshortener/internal/handlers URLshortener
//
